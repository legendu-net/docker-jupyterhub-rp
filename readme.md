# [dclong/jupyterhub-rp](https://hub.docker.com/r/dclong/jupyterhub-rp/)

JupyterHub and R (with popular packages) in Docker.
...
```
docker pull dclong/jupyterhub-rp
```
...
```
docker pull registry.docker-cn.com/dclong/jupyterhub-rp
```
